                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td valign="middle" align="center"
                                        style="font-family:'Open Sans', Arial, sans-serif; font-size:28px; font-weight:bold; line-height:22px; color:#fe3957; text-transform:uppercase;">{{__("mail.failed_order.title")}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td valign="middle" align="center"
                                        style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:22px; color:#fe3957; text-transform:uppercase;">{{__("mail.failed_order.subtitle")}}  </td>
                                </tr>
                                <tr>
                                    <td height="25" class="em_height">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    <td valign="top" align="center"
                                        style="font-family:'Open Sans', Arial, sans-serif; font-size:17px;line-height:22px; font-weight:bold; color:#30373b; text-transform:uppercase;">{{__("mail.failed_order.review_order")}}</td>
                                </tr>
                                <tr>
