<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="first_name" value="{{ __u('models.user.first_name') }}" />
        ...
        <!-- Last Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="last_name" value="{{ __u('models.user.last_name') }}" />
        ...
        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="email" value="{{ __u('models.user.email') }}" />
        ...
        <!-- Mobile -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="mobile" value="{{ __u('models.user.mobile') }}" />
        ...
        <!-- Birth date -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="birthday" value="{{ __u('models.user.birthday') }}" />
            <x-jet-input id="birthday" type="date" class="mt-1 block w-full" wire:model.defer="state.birthday" timezone="{{config('app.timezone')}}"/>
