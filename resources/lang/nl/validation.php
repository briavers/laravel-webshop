...
return [
    ...
    'attributes' => [
        ...
        'products.*.size' => 'grootte',
        'products.*.color' => 'kleur',
        'products.*.color_code' => 'kleurcode',
        'products.*.unit_price' => 'stuksprijs',
        'products.*.cost' => 'kosten',
        'products.*.discount' => 'korting',
        'name_nl' => 'Nederlandse naam',
        'name_fr' => 'Franse naam',
        'name_en' => 'Engelse naam',
        'desc_nl' => 'Nederlandse beschrijving',
        'desc_fr' => 'Franse beschrijving',
        'desc_en' => 'Engelse beschrijving',
    ],
];
